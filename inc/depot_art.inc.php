...
if($id_depot === FALSE) {
	...
	foreach($db->data as $r) {
		$aArticles[] = "<tr id='a".$r['idarticle']."'><td style='background-color:".$r['code_couleur']."'><b>".$r['depot_iddepot'].'-'.$r['idarticle']."</b></td>".
		"<td><img src='img/edit.gif' onclick='modif(".$r['idarticle'].")' title='Modifier' />".
		"<img src='img/del.gif' onclick='suppr(".$r['idarticle'].")' title='Supprimer' />".
		"</td><td>".$r['description']."</td><td>".$r['prix_achat']."&euro;</td><td>".$r['prix_vente']."&euro;</td></tr>";
 	}
}
