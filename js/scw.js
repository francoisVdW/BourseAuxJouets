...
//
// FVDW : manual removed see the full descirption at http://www.garrett.nildram.co.uk/calendar/scw.htm
// *****************************************************************************
//
// See http://www.tarrget.info/calendar/scw.htm for a complete version history
//
// FVDW : Please see link below for revision history (cut for smaler file size)
...
//******************************************************************************
    ...
    var scwDropDownYears   = 81;
    // FVDW date valides de aujourd'hui - 70 ans --> aujourd'hui + 10 ans (max pour CACES)  
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwClear               = 'RaZ';
             scwDrag                = 'Cliquez ici pour me déplacer...';
             scwArrMonthNames       = ['Jan','Fév','Mars','Avril','Mai','Juin',
                                       'Juil','Aout','Sep','Oct','Nov','Déc'];
             scwArrWeekInits        = ['D','L','M','M','J','V','S'];
             scwInvalidDateMsg      = 'La date est invalide.\n';
             scwOutOfRangeMsg       = 'La date est en dehors des limites.';
             scwDoesNotExistMsg     = 'La date n\'existe pas.';
             scwInvalidAlert        = ['Date invalide (',') ingorée.'];
    ...
    document.writeln(
        '<style type="text/css">'+
            ...
            '/* Calendar background */'+
            'table.scw	{background-color:  #D6E1E5;}'+
            '/* Drag Handle */'+
            'td.scwDrag	{background-color: #9999CC;color: #CCCCFF;}'+
            '/* Week number heading */'+
            'td.scwWeekNumberHead	{color:	#0A2862;}'+
            '/* Week day headings */'+
            'td.scwWeek	{color:	#0A2862;}'+
            '/* Week numbers */'+
            ...
            'td.scwInputDate	{background-color:  #0A2862;'+
								'color:             #FFFFFF;}'+
            '/* Weekend Day */'+
            ...
            '/* Today selector */'+
            'td.scwNow:hover,'+
            'td.scwNowHover	{background-color:  #FFFF00;'+
							'cursor:            pointer;}'+
            '/* Disabled cells */'+
            '/* Week Day */'+
            '/* Day matching the input date */'+
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;'+
										'color:             #666666;}'+
            'td.scwNowDisabled	{color:             #0A2862;}'+
        '</style>');
